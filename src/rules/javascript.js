        ...
        check: (code, language) => {
            ...
            patterns.forEach(pattern => {
                ...
                while ((match = pattern.exec(code)) !== null) {
                    ...
                    if (match[0].includes('md5'))
                        algorithm = 'MD5';
                    else if (match[0].includes('sha1'))
                        algorithm = 'SHA1';
                    else if (match[0].includes('des3') || match[0].includes('des-ede3'))
                        algorithm = '3DES';
                    else if (match[0].includes('des'))
                        algorithm = 'DES';
                    else if (match[0].includes('rc4'))
                        algorithm = 'RC4';
                    vulnerabilities.push({
